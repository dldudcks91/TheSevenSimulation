...
현재 전투 관련 수치:
- 영웅: HP = 200 + 힘×10 (스탯 총합 70, 각 2~18). 병사가 먼저 피격
...
| 영웅 유형 | 힘 | 민첩 | 건강 | HP | ATK(원정) | ATK(방어) |
|---|---|---|---|---|---|---|
| 근접형 (힘 특화) | 16 | 10 | 12 | 360 | 15.2 | 12.8+통솔 |
| 균형형 | 10 | 10 | 10 | 300 | 11.0 | 8.0+통솔 |
| 허약형 (지능 특화) | 4 | 6 | 6 | 240 | 5.2 | 3.2+통솔 |
| **평균** | **10** | **10** | **10** | **300** | **11.0** | - |

> 공식: HP = 200 + 힘×10, ATK(원정) = 힘×0.7 + 민첩×0.4
> 건강은 전투 미반영 — 스태미나(체력) 풀 + 발병 저항 전용
> 성장 반영: Lv3~4 시 관련 스탯 +2~3 → 근접형 HP 380~390, ATK 16~17 수준
...
들늑대 ATK 8 vs 영웅 HP 350 → 약 44턴 킬
→ 영웅 압승. 의도대로.

영웅 ATK 5 (허약형) vs 변이 곰 HP 70 → 약 14턴 킬
변이 곰 ATK 11 vs 영웅 HP 310 → 약 28턴 킬
→ 허약형도 이기긴 하지만 HP 절반 소모. 의도대로.
```
