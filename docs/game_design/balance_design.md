...
현재 전투 관련 수치:
- 영웅: HP = 200 + 체력×15 + 힘×5 (스탯 총합 70, 각 2~18)
...
**"영웅은 숫자가 아니라 구성으로 강해진다"**

- 영웅 개인 전투력은 고정 (스탯 변동 없음, Phase 1)
- 강해지는 방법: 카드 확보, 병사 수 유지, 편성 최적화, 장비(Phase 2)
...
| 영웅 유형 | 힘 | 민첩 | 체력 | HP | ATK(원정) | ATK(방어) |
|---|---|---|---|---|---|---|
| 근접형 (힘 특화) | 16 | 10 | 12 | 380 | 15.2 | 12.8+통솔 |
| 균형형 | 10 | 10 | 10 | 350 | 11.0 | 8.0+통솔 |
| 허약형 (지능 특화) | 4 | 6 | 6 | 310 | 5.2 | 3.2+통솔 |
| **평균** | **10** | **10** | **10** | **350** | **11.0** | - |

> 공식: HP = 200 + 체력×15 + 힘×5, ATK(원정) = 힘×0.7 + 민첩×0.4
...
목표:
- 평균 사기 = 50 (안정 구간 중앙)
- 5~8턴마다 1명은 위험 구간(0~30 또는 71~100)에 진입
...
| HeroManager | 사기 판정 임계값 30/70 | lines 259-263 | morale_unhappy_threshold 등 |
...
*마지막 업데이트: 2026-03-29 (초안 — 전투/경제/사기 3영역 밸런스 예시)*
