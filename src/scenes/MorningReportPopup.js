...
import { SIN_NAMES_KO } from '../game_logic/SinUtils.js';
...
class MorningReportPopup {
    ...
    _drawHeroEntry(ox, y, entry, isAlert, container) {
        ...
        const sinColor = SIN_COLORS[entry.dominantSin] || '#a0a0c0';
        ...
        // 죄종 태그
        const sinLabel = entry.sinName || SIN_NAMES_KO[entry.dominantSin] || '?';
        const sinTag = this.scene.add.text(ox + 36 + nameText.width + 8, y + 3, `[${sinLabel}]`, {
